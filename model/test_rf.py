...
def predict_refined_floatingobjects(model, region):
    ...
    if rf_number == 3:
        y_binary = np.array([y == 1 for y in y_pred])
    else:
...
rf_classifier_paths = ['/data/sushen/marinedebris/MARIDA/rf_classifier_ss.joblib', 
    ...
    '/data/sushen/marinedebris/project/rf_classifier.joblib'] #4 is the rf trained on marida scenes
rf_classifier_path = rf_classifier_paths[3]
